...
import com.vaydeal.member.intfc.validation.GetMemberReportValidator;
 ...
 * @author rifaie
 */
public class GetMemberReportConstraints implements GetMemberReportValidator {

    private final GetMemberReport req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetMemberReportConstraints(GetMemberReport req) throws Exception {
        this.req = req;
