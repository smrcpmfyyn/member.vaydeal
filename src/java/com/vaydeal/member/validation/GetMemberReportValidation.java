 ...
 * @author rifaie
 */
public class GetMemberReportValidation implements Validation{
    
    private final GetMemberReport req;
    private String paramValue = "";
    private String paramName = "";

    public GetMemberReportValidation(GetMemberReport gu) {
        this.req = gu;
    }

    @Override
    public void validation() throws Exception {
        GetMemberReportConstraints reqC = new GetMemberReportConstraints(req);
        String valid = "";
