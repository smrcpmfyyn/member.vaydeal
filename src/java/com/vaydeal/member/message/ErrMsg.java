...
public class ErrMsg {
    ...
    public static final String ERR_BANK = "Invalid bank invalid";
    public static final String ERR_PIN = "Invalid pin invalid";
    public static final String ERR_BRANCH = "Invalid branch invalid";
    ...
    public static final String ERR_IFSC = "Invalid ifsc invalid";
    public static final String ERR_CITY = "Invalid city invalid";
