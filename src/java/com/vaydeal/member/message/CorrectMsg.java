...
public class CorrectMsg {
    ...
    public static final String CORRECT_BANK = "Valid bank";
    public static final String CORRECT_PIN = "Valid pin";
    public static final String CORRECT_BRANCH = "Valid branch";
    ...
    public static final String CORRECT_IFSC = "Valid ifsc";
    public static final String CORRECT_CITY = "Valid city";
