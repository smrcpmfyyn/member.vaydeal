 ...
 * @author rifaie
 */
public class GetMemberReportFailureResponse {

    private final GetMemberReportResult reqR;
    private final String error;

    public GetMemberReportFailureResponse(GetMemberReportResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
